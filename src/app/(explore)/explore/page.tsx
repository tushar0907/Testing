      ...
      <div className="w-screen mobile:mt-12 h-[800px] mobile:pl-2 pl-10 mobile:h-auto py-[50px] mobile:py-0">
        ...
        <div className="mb-12">
          ...
          <div className="flex flex-wrap justify-between pb-4 smob:mx-1 mobile:mx-4 mx-1">
            <div className="flex-none my-2 mx-2 rounded-[8px] w-[300px] overflow-hidden relative tab:w-[250px] smob:min-w-[150px] mobile:h-[220px] mobile:w-[170px]">
        ...
        {/* <div className="mb-12">
          ...
          <div className="flex space-x-[15px] overflow-x-auto pb-4">
            {[...Array(6)].map((_, index) => (
              <div
                key={index}
                className="flex-none w-[300px] rounded-[8px] overflow-hidden relative tab:w-[250px]  smob:min-w-[150px] mobile:h-[220px] mobile:w-[170px]"
              >
